...
---
This repository contains a web-based card game prototype focused on
modular JavaScript architecture, object-oriented game logic,
and integration of designer-created assets into a working application.
---
